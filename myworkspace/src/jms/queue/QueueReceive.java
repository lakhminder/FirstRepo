...
public class QueueReceive implements MessageListener {
	...
	// Defines the queue.
	//public final static String QUEUE = "mdaQueue";
	
	public final static String QUEUE = "/local/jms/jms_server1/jms_queue1";
	//public final static String QUEUE = "System.SUN1.ApplicationType.ServiceActivation.Application.1-0;4-7;ASAP.Comp.MessageQueue";
	...
	public void init(Context ctx, String queueName) throws NamingException,
		...
		qreceiver.setMessageListener(this);//object of class that implements message listener
		qcon.start();
	}
