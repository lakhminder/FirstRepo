...
import org.lucky.projects.maven.jersey.messenger.example8SubResource.service.CommentService;



/**
 * 
 * @Path is optional for the Subresource class like this as path is inferred from parent
 * @PathParam("messageId") is available in subresource as well
 *
 */
